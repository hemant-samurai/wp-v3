...
function et_divi_load_scripts_styles(){
	...
	//wp_enqueue_script( 'divi-multiscroll-script', $template_dir . '/js/jquery.multiscroll.js', array( 'jquery' ) , $theme_version, true );
    //wp_enqueue_script( 'divi-easings-script', $template_dir . '/js/jquery.easings.min.js', array( 'jquery' ) , $theme_version, true );
	...
	//wp_enqueue_style( 'multiscroll-style', $template_dir . '/css/jquery.multiscroll.css', array(), $theme_version );
