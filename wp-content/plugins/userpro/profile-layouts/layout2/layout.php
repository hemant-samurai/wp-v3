...
?>  
      ...
      <div class="container" id="main_section">
           ...
           <div class="row overlay">
                         ...
                         <div class="col-lg-12 col-xs-12" id="header_bg" style="background-image:url(<?php echo $background_pic;?>);">
          ...
          <div class="row upl-count-bg">
                   ...
                   <div class="col-lg-4 col-lg-offset-4 col-sm-4 col-xs-4 connect">
                        ...
                        <span class="number-conn"><?php echo str_ireplace('following','',$userpro_social->following_count( $user_id )); ?></span><br>
                 ...
                 <div class="col-lg-4 col-lg-offset-4 col-sm-4 col-xs-4 connect">
                        ...
                        <span class="number-conn"><?php echo str_ireplace('followers','',$userpro_social->followers_count( $user_id )); ?></span><br>
                 ...
                 <div class="col-lg-4 col-lg-offset-4 col-sm-4 col-xs-4 connect">
                     <span class="number-conn"><?php echo str_ireplace('connections','', $userpro->connetions_count($user_id)); ?></span><br>
<!--                         <a href="< ?php echo $userpro->permalink($user_id, 'connection', 'userpro_sc_pages'); ?>" class="userpro-count-link" style="color:white !important">< ?php _e('CONNECTIONS','userpro');?></a>-->
           ...
           <div class="row" style="margin-top: 4%">
                                 ...
                                 <div class="col-lg-4 col-sm-4 text-center text-right">
                                     <?php echo upl_follow_text($user_id, get_current_user_id()); ?>
                                  </div><!--follow-button-->
