/**
 *  Advanced iframe pro external workaround file v7.3.x
 *  Created: 2017-01-02 20:46:04 
*/ 
if (typeof domain_advanced_iframe === 'undefined') {
    var domain_advanced_iframe = 'http://54.236.87.96/wp-content/plugins/advanced-iframe'; // Check if this is this is the path to the main directory of aip
}
...
if (doIt) {
  ...
  var post_message_domain = "http://54.236.87.96"; 
  ...
  if (typeof jquery_path === 'undefined') {
      var jquery_path = 'http://54.236.87.96/wp-includes/js/jquery/jquery.js';
  }
  if (typeof resize_path === 'undefined') {
      var resize_path = 'http://54.236.87.96/wp-content/plugins/advanced-iframe/includes/scripts/jquery.ba-resize.min.js';
  }
